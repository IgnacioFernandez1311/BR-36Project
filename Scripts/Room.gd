...
func connect_exit_unlocked(direction : String, room, room_2_override_name = "null") -> RoomExit:
	return _connect_exit(direction, room, false, room_2_override_name)

func connect_exit_locked(direction : String, room, room_2_override_name = "null") -> RoomExit:
	return _connect_exit(direction, room, true, room_2_override_name)

func _connect_exit(direction : String , room, is_locked : bool = false, room_2_override_name = "null") -> RoomExit:
	
	var room_exit : RoomExit = RoomExit.new()
	room_exit.room_1 = self
	room_exit.room_2 = room
